...
const envValidation = Joi.object()
    .keys({
        ...
        JWT_VERIFY_USERNAME_EXPIRATION_MINUTES: Joi.number()
            .default(10)
            .description('minutes after which verify userName token expires'),
...
export const config = {
    ...
    jwt: {
        ...
        verifyUserNameExpirationMinutes: envVar.JWT_VERIFY_USERNAME_EXPIRATION_MINUTES,
    },
    logConfig: {
